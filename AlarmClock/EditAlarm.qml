...
Rectangle{
    ...
    property string pHour
    property int pIndex
    property string pMinutes
    property string pStatus
    property string psong
    property string pDay
    ...
    ColumnLayout{
        ...
        RowLayout{
            ...
            Rectangle{
                ...
                anchors.bottom:cancel_save.top
                ColumnLayout{
                    width:parent.width
                    ...
                    ComboBox {
                        ...
                        currentIndex: ["EveryDay","Monday", "Tuesday", "Wednesday", "Thursday","Friday","Saturday","Sunday"].indexOf(pDay)
